...
# prevent log file changing in size while appending to zip package
sleep 0.5 
# use above package name to append log file
...
case $1 in
		...
		-h) 
			...
			echo "     ./linux_cpu_tracer.sh -n, network packet capture on ALL interfaces"
			echo "                                                                                      "
